...
//Example1 : var (Hosted with undefined) , let and const (Not Initialized)

// Note: With undefinbed var we can still access the variable before its declaration, but it will be undefined. 
// This can lead to bugs and confusion in larger codebases, which is why it's generally recommended to avoid using var in modern JavaScript/TypeScript development.

//console.log(a); // Undefined (var is hoisted)
var a = 10;
console.log(a)

// Note: With let and const, accessing the variable before its declaration will result in a ReferenceError 
