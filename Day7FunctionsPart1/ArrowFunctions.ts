...
// Example 3: Arrow Function with Implicit Return meaning no need to use the return keyword 
// and curly braces if the function body contains only a single expression. 
...
/* let testone = (a: string, b: string): string => { 
  let final: string = a + b; 
  console.log(final); 
  return final; 
};


let testtwo = (a: string, b: string): string => a+b

console.log(testone("Hello", " TypeScript"));
console.log(testtwo("Hello", " TypeScript")); */