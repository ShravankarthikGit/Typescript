...
To save mulerplie values we can use non-premitive data types which are user defined data types and they are used to
 store multiple values in a single variable. these are similar to collections
