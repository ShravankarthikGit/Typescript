...
// Note that we cant access the values from the object directly
// When you print typeof employee, JavaScript returns "object" because at runtime, it is just a standard object. However, during development, 
// TypeScript blocks you from 
// accessing employee.name because the primitive : object type represents any non-primitive value, but guarantees zero specific properties
...
console.log(employee2.name, employee2.salary, employee2.job); //John 50000 Engineer
console.log(employee2.getDetails()); //John is a Engineer earning 50000
...
//Modify the value
employee2.job = "Manager";   //employee["job"]="Manager";
console.log("Modified job is:", employee2.job); // Manager
